...
$PANELNAME='ESI Statistics'; //Panel name (optional)
//standard header ends here
?>

<h2>ESI Statistics</h2>
<h3>Real time</h3>
...
<script type="text/javascript">
    pollerEsiRealTime('pollerDate','pollerFile','pollerMsg','pollerActive');
    window.setInterval(function(){ pollerEsiRealTime('pollerDate','pollerFile','pollerMsg','pollerActive'); }, 5000);
</script>

	<?php
		include("../Notifications/checkpoller.php");  
	?>
...
<h3>Poller statistics [seconds]</h3>
	...
	foreach($data as $row) {
		echo('<tr><td class="tab">');
				...
				if ($row['errorCode'] >= 0 && $row['errorCode'] <= 200 ) $color="#00a000";
