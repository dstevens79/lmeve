...
include_once('../../Site_Core/materials.php');
include_once('../Inventory/inventory.php');
include_once('../../Graphics/Yaml/yaml_graphics.php');
include_once('../../Site_Core/skins.php');
...
//API URLs 
		...
		<tr>
                    ...
                    ?>
                    <td>LMeve API <a href="../../Site_Core/api.php?<?=$apikey?>endpoint=INVTYPES&typeID=<?=$nr?>" target="_blank">api.php?<?=$apikey?>endpoint=INVTYPES&typeID=<?=$nr?></a></td>
                </tr>
                <?php /*<tr>
