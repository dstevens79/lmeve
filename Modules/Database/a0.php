...
?>
	...
	if (!empty($marketGroupID)) {
		...
		*/
		?>
			<tr><td>
				<b><a href="../../Site_Core/?id=10&id2=0&marketGroupID=<?php echo($parentGroupID); ?>"><img src="<?=getUrl()?>ccp_icons/23_64_1.png" style="width: 32px; height: 32px;" title="Parent Group" /></a></b>
			</td><td>
				<b><a href="../../Site_Core/?id=10&id2=0&marketGroupID=<?php echo($parentGroupID); ?>">..</a></b>
			</td>
